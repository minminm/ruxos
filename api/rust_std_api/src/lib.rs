...
pub use ruxhal::misc::terminate as terminate;
pub use ruxhal::time::{current_time as current_time, TimeValue as AxTimeValue};
...
//
// These functions are used to support rust-std.
//
